        ...
        <div className="min-h-screen p-8 sm:p-20 font-sans">
            <main className="flex flex-col gap-8 mt-10 sm:items-start">
                ...
                <section>
                    ...
                    <h4>What to Bring</h4>
                    <ul>
                        <li><strong>Clothing:</strong> Shorts are required for baptism and can be purchased locally if needed.</li>
                        <li><strong>Shelter:</strong> Independent travelers should bring tents if not using agency accommodations.</li>
                        <li><strong>Food:</strong> Pack meals suitable for hot climates or purchase from local shops.</li>
                        <li><strong>For Women:</strong> Bring tampons, as they are expensive locally. Women cannot be baptized during their menstrual periods and must wait until the eighth day from its onset. Alternatively, they may baptize at the nearby Yordanos holy water site.</li>
                    </ul>

                    <h4>Surrounding Area</h4>
                    <ul>
                        <li>
                            <strong>Local Highlights:</strong><br />
                            <p>
                        ...
                        <li>
                            <strong>Nearby Holy Water Sites:</strong>
                            <ul>
                                <li><em>Mrt Delego Kidane Mihret</em>: Offers a gentler baptism experience with water flowing smoothly from underground.</li>
                                <li><em>Yordanos Holy Water</em>: Allows women to be baptized during their menstrual periods.</li>
                            </ul>
                        </li>
                    </ul>

                    <h4>Network Access</h4>
                    <p>While there is network coverage for calls, internet access is unavailable, at this moment of writing.</p>
                    ...
                    <h4>Spiritual and Practical Guidelines</h4>
                    <ul>
                        <li><strong>Confession:</strong> It is recommended to confess before baptism. While not mandatory, Saint George may encourage you to do so before subsequent baptisms.</li>
                        <li><strong>Showers:</strong> Many visitors shower in a nearby river or village before baptism.</li>
                        <li><strong>Safety During Travel:</strong> Saint George is believed to guide visitors, protecting them from financial or logistical challenges.</li>
                    </ul>

                    <h4>Who Can Be Baptized</h4>
                    <p>
                    ...
                    <h4>Costs</h4>
                    <p>There is no fee for visiting the holy site or participating in its spiritual practices. Travel and accommodation expenses are the visitor&apos;s responsibility.</p>

                    <h4>Sharing Your Testimony</h4>
                    <p>Visitors may be called upon to share their experiences as a testimony, either at the church or elsewhere.</p>
                    ...
                    pages for more details about planning your visit.
                </section>
